...
FIRST_ATTEMPT_WRONG = {"hp2": "London", 
                       "hp4": "Atlantic Ocean", 
                       "hp6": "Red Sea", 
                       "hp8": "Andes"}

FAILURE_MODE_BY_QID = {"hp2": "incomplete_multi_hop", 
...
def evaluator(example: QAExample, answer: str) -> JudgeResult:
    '''
    bộ đánh giá câu trả lời đúng hay sai
    '''
...
def reflector(example: QAExample, attempt_id: int, judge: JudgeResult) -> ReflectionEntry:
    '''
    bộ tạo reflection sau khi trả lời sai
    '''
